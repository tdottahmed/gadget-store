...
@if (isset($announcement) && $announcement['status'] == 1)
  <div class="position-relative d--none px-4 py-1 text-center" id="announcement"
          ...
          <div class="topbar-text dropdown disable-autohide mr-4">
            ...
            <ul
              ...
              @foreach (\App\Models\Currency::where('status', 1)->get() as $key => $currency)
                <li class="dropdown-item get-currency-change-function cursor-pointer"
  ...
  <div class="navbar-sticky bg-light mobile-head">
    <div class="navbar navbar-expand-md navbar-light">
      <div class="container">
        ...
        <a class="navbar-brand d-none d-sm-block __min-w-7rem me-3 flex-shrink-0" href="{{ route('home') }}">
        ...
        <a class="navbar-brand d-sm-none" href="{{ route('home') }}">
          <img class="mobile-logo-img" src="{{ getStorageImages(path: $web_config['mob_logo'], type: 'logo') }}"
               alt="{{ $web_config['company_name'] }}" />
        </a>
        ...
        <div class="input-group-overlay mx-lg-4 search-form-mobile text-align-direction">
          <form action="{{ route('products') }}" type="submit" class="search_form">
            <div class="d-flex align-items-center gap-2">
              <input class="form-control appended-form-control search-bar-input" type="search" autocomplete="off"
                     data-given-value="" placeholder="{{ translate('search_for_items') }}..." name="name"
                     value="{{ request('name') }}">
              ...
              <span class="close-search-form-mobile fs-14 text-muted d-md-none text-nowrap font-semibold"
                    type="submit">
                {{ translate('cancel') }}
              </span>
            </div>
            ...
            <diV class="card search-card mobile-search-card">
              <div class="card-body">
                <div class="search-result-box __h-400px overflow-y-auto overflow-x-hidden"></div>
              </div>
            </diV>
          </form>
        </div>

        <div class="navbar-toolbar d-flex align-items-center flex-shrink-0">
          ...
          @else
            <div class="dropdown">
              <a class="navbar-tool {{ Session::get('direction') === 'rtl' ? 'mr-md-3' : 'ml-md-3' }}" type="button"
                 data-toggle="dropdown" aria-haspopup="true" href="#" rel="nofollow" aria-expanded="false">
                <div class="navbar-tool-icon-box bg-secondary">
                  <div class="navbar-tool-icon-box bg-secondary">
    ...
    <div class="navbar navbar-expand-md navbar-stuck-menu">
      <div class="px-10px container">
        <div class="navbar-collapse text-align-direction collapse" id="navbarCollapse">
          ...
          <ul class="navbar-nav mega-nav pr-lg-2 pl-lg-2 d-none d-md-block __mega-nav mr-2">
          ...
          <ul class="navbar-nav mega-nav1 pr-md-2 pl-md-2 d-block d-xl-none">
            <li class="nav-item dropdown d-md-none">
              <a class="nav-link dropdown-toggle ps-0" href="javascript:" data-toggle="dropdown">
                <i class="czi-menu mt-n1 me-2 align-middle"></i>
                <span class="me-4">
                  {{ translate('categories') }}
                </span>
              </a>
          ...
          <ul class="navbar-nav">
            ...
            @elseif(count(getFeaturedDealsProductList()) > 0 ||
              ...
              <li class="nav-item">
                <div class="dropdown">
                  <button class="btn dropdown-toggle text-max-md-dark text-capitalize ps-2 text-white" type="button"
            ...
            @if ($businessMode == 'multi')
              @if (getWebConfig(name: 'seller_registration'))
                <li class="nav-item">
                  <div class="dropdown">
                    <button class="btn dropdown-toggle text-max-md-dark text-capitalize ps-2 text-white"
