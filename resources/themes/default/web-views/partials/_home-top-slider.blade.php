    ...
    <section class="bg-transparent py-3">
        <div class="position-relative container">
            <div class="row align-items-stretch">
                <div class="col-12 col-lg-9 col-xl-9 home-slider-left-banner">
                    <div class="{{ Session::get('direction') === 'rtl' ? 'pe-xl-2' : 'ps-xl-2' }}">
                        <div class="owl-carousel owl-theme hero-slider h-100" style="margin-right: 10px !important"
                ...
                @if ($bannerTypeMainSideBannerTop || $bannerTypeMainSideBannerBottom)
                    <div class="col-12 col-lg-3 col-xl-3 d-flex flex-column side-banner-wrapper me-0">
                        @if ($bannerTypeMainSideBannerTop)
                            <a href="{{ $bannerTypeMainSideBannerTop['url'] }}" target="_blank"
                                class="d-block side-banner-item mb-2 home-banner-top-image">
                        ...
                        @if ($bannerTypeMainSideBannerBottom)
                            <a href="{{ $bannerTypeMainSideBannerBottom['url'] }}" target="_blank"
                                class="d-block side-banner-item">
                                <img class="w-100 h-100 object-fit-cover rounded"
