...
@section('content')
  ...
  <div class="rtl __inline-56 px-md-3 text-align-direction container px-0 py-4">
    <div class="row mx-max-md-0">
      <div class="col-md-12 mb-3">
        <h3 class="font-weight-bold text-lg-left text-center">{{ translate('checkout') }}</h3>
      </div>
        ...
        <div class="checkout_details">
          ...
          @if ($physical_product_view)
            ...
            <div class="px-md-0 px-3">
              <h4 class="fs-18 text-capitalize mt-4 pb-2">{{ translate('shipping_address') }}</h4>
            </div>
                              ...
                              <div class="dropdown-item select_shipping_address {{ $key == 0 ? 'active' : '' }}"
                                ...
                                <div class="media gap-2">
                                  ...
                                  <div class="media-body">
                                    <div class="text-capitalize mb-1">{{ $address->address_type }}</div>
                        ...
                        <div class="mt-3">
                          <div class="row">
                            ...
                            <div class="col-sm-6">
                              <div class="form-group">
                                ...
                                <input type="tel" class="form-control" id="phone"
                                       {{ $shippingAddresses->count() == 0 ? 'required' : '' }} name="phone">
                              </div>
                            </div>
                            ...
                            <div class="col-12">
                              <div class="form-group mb-1">
                                ...
                                <span class="fs-14 text-danger font-semi-bold map-address-alert opacity-0">
                                  {{ translate('note') }}:
                          ...
                          @if (getWebConfig('map_api_status') == 1)
                            <div class="form-group location-map-canvas-area map-area-alert-border">
                              <input id="pac-input" class="controls __inline-46 location-search-input-field rounded"
                          ...
                          <div class="d-flex align-items-center gap-3">
                            <label class="form-check-label d-flex align-items-center gap-2" id="save_address_label">
                          ...
                          <input type="hidden" id="latitude" name="latitude" class="form-control d-inline"
                                 ...
                                 value="{{ $defaultLocation ? $defaultLocation['lat'] : 0 }}" required readonly>
                          <input type="hidden" name="longitude" class="form-control"
                                 placeholder="{{ translate('ex') }} : 103.344322" id="longitude"
                                 value="{{ $defaultLocation ? $defaultLocation['lng'] : 0 }}" required readonly>
              ...
              <div class="card __card mt-3">
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <div class="min-h-45 form-check d-flex align-items-center user-select-none cursor-pointer gap-3">
                      ...
                      <div class="d-flex flex-sm-nowrap flex-wrap gap-3">
                        <div class="w-100">
                          <div class="password-toggle rtl">
                            <input class="form-control text-align-direction" name="customer_password" type="password"
                                   id="customer_password" placeholder="{{ translate('new_Password') }}" required>
                        ...
                        <div class="w-100">
                          <div class="password-toggle rtl">
                            <input class="form-control text-align-direction w-100" name="customer_confirm_password"
                                   type="password" id="customer_confirm_password"
          ...
          @if ($billingInputByCustomer)
            <div>
              <div class="billing-methods_label d-flex justify-content-between px-md-0 mt-4 flex-wrap gap-2 px-3 pb-3">
                <h4 class="fs-18 text-capitalize mb-0">{{ translate('billing_address') }}</h4>
              ...
              @if (!$physical_product_view)
                <div class="alert--info mb-3">
                  <div class="d-flex align-items-center gap-2">
                    <img class="mb-1" src="{{ theme_asset('public/assets/front-end/img/icons/info-light.svg') }}"
                         alt="Info">
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="tel" class="form-control phone-input-with-country-picker-2"
                              ...
                              <div class="col-6">
                                <div class="form-group">
                                  ...
                                  @if ($zip_restrict_status)
                                    <select name="billing_zip" class="form-control selectpicker"
                            ...
                            @if (getWebConfig('map_api_status') == 1)
                              <div class="form-group map-area-alert-border location-map-billing-canvas-area">
                                <input id="pac-input-billing"
                                       class="controls __inline-46 location-search-input-field rounded"
                                       title="{{ translate('search_your_location_here') }}" type="text"
                                       placeholder="{{ translate('search_here') }}" />
                  ...
                  <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                    ...
                    <div class="is_check_create_account_password_group d--none">
                      <div class="d-flex flex-sm-nowrap flex-wrap gap-3">
                        ...
                        <div class="w-100">
                          <div class="password-toggle rtl">
                            <input class="form-control text-align-direction" name="customer_confirm_password"
                                   type="password" id="customer_confirm_password"
                                   placeholder="{{ translate('confirm_Password') }}" required>
                            <label class="password-toggle-btn">
                              <input class="custom-control-input" type="checkbox">
...
@push('script')
  ...
  @if (getWebConfig('map_api_status') == 1)
    <script src="https://maps.googleapis.com/maps/api/js?key={{ getWebConfig('map_api_key') }}&callback=mapsShopping&loading=async&libraries=places&v=3.56"
            defer></script>
  @endif
@endpush
