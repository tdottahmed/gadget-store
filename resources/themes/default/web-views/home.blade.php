  ...
  <div class="__inline-61">
    ...
    @if ($featuredProductsList->count() > 0)
      <div class="rtl px-md-3 container px-0 pt-4">
        <div class="__inline-62 pt-3">
          ...
          <div class="d-none d-md-block px-3 text-end">
          ...
          <div class="feature-product">
            ...
            <div class="d-md-none pt-2 text-center">
              <a class="text-capitalize view-all-text web-text-primary"
                 href="{{ route('products', ['data_from' => 'featured', 'page' => 1]) }}">
                {{ translate('view_all') }}
                <i
      ...
      <section class="featured_deal">
        <div class="container">
          <div class="__featured-deal-wrap bg--light">
            <div class="d-flex justify-content-between mb-3 flex-wrap gap-8">
              <div class="flex-grow-1 w-0">
                <span class="featured_deal_title text-dark font-bold">{{ translate('featured_deal') }}</span>
                <br>
                <span
                      class="text-nowrap text-left">{{ translate('see_the_latest_deals_and_exciting_new_offers') }}!</span>
              </div>
              <div>
                <a class="text-capitalize view-all-text web-text-primary"
    ...
    <section class="new-arrival-section">
      ...
      @if ($newArrivalProducts->count() > 0)
        ...
        <div class="rtl container mb-3 overflow-hidden">
          <div class="py-2">
