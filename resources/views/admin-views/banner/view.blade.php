...
@section('content')
  <div class="content container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3 gap-3">
      <h2 class="h1 text-capitalize d-flex align-items-center mb-1 gap-2">
      ...
      <div class="btn-group">
        ...
        <div
             class="dropdown-menu dropdown-menu-right bg-aliceblue border-color-primary-light dropdown-w-lg-30 border p-4">
          <div class="d-flex align-items-center mb-3 gap-2">
            <img width="20" src="{{ dynamicAsset(path: 'public/assets/new/back-end/img/note.png') }}" alt="">
            <h5 class="text-primary mb-0">{{ translate('note') }}</h5>
          </div>
          <p class="text-dark fs-12 fw-medium mb-0">{{ translate('currently_you_are_managing_banners_for') }}
            {{ ucwords(str_replace('_', ' ', theme_root_path())) }}
            {{ translate('these_saved_data_is_only_applicable_only_for') }}
            {{ ucwords(str_replace('_', ' ', theme_root_path())) }}
            ...
            {{ translate('if_you_switch_back_to') }} {{ ucwords(str_replace('_', ' ', theme_root_path())) }}
            {{ translate('_again_,_you_will_see_the_saved_data.') }}
          </p>
        </div>
      </div>
    </div>

    <div class="row d--none pb-4 text-start" id="main-banner">
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  <div class="h-100">
                    ...
                    <div class="form-group d--none mb-0" id="resource-category">
                      <label for="name" class="form-label">
                        {{ translate('category') }}
                      </label>
                    ...
                    <div class="form-group d--none mb-0" id="resource-shop">
                    ...
                    <div class="form-group d--none mb-0" id="resource-brand">
                    ...
                    @if (theme_root_path() == 'theme_fashion')
                      <div class="form-group input-field-for-main-banner mt-4">
                      ...
                      <div class="form-group input-field-for-main-banner mb-0">
                      ...
                      <div class="form-group input-field-for-main-banner mb-0 mt-4">
                        <label for="background_color" class="form-label">
                          {{ translate('background_color') }}
                        </label>
                        <input type="color" name="background_color" class="form-control h-80px px-2 py-2"
                ...
                <div class="col-md-6 d-flex flex-column justify-content-center">
                  <div class="d-flex justify-content-center align-items-center bg-section rounded-8 w-100 h-100 p-20">
                    <div class="d-flex flex-column gap-30 w-100">
                      ...
                      <div class="upload-file">
                        ...
                        <div class="overlay">
                          <div class="d-flex justify-content-center align-items-center h-100 gap-10">
        ...
        <div class="card">
          <div class="card-body d-flex flex-column gap-20">
            <div class="row gy-3 align-items-center">
              <div class="col-xl-4 mb-md-0 mb-2">
                <h3 class="mb-0">
                  {{ translate('banner_table') }}
                  <span class="badge text-dark bg-body-secondary fw-semibold rounded-50">{{ $banners->total() }}</span>
                </h3>
              </div>
              <div class="col-xl-8">
                <div class="row gy-2 gx-2 align-items-center text-left">
                    ...
                    <form action="{{ url()->current() }}" method="GET">
                      <div class="row gy-2 gx-2 align-items-center text-left">
                        <div class="col-sm-12 col-md-9">
                          <div class="select-wrapper">
                            <select class="form-control" name="searchValue" id="date_type">
                              ...
                              @foreach ($bannerTypes as $key => $banner)
                                <option value="{{ $key }}"
                                        {{ request('searchValue') == $key ? 'selected' : '' }}>{{ $banner }}
                                </option>
                              @endforeach
                            </select>
                          </div>
                        ...
                        <div class="col-sm-12 col-md-3">
                          <button type="submit" class="btn btn-primary w-100 text-nowrap px-4">
                            {{ translate('filter') }}
                          </button>
                        </div>
                      </div>
                  ...
                  <div class="col-sm-12 col-lg-3">
                    <div id="banner-btn">
                      <button id="main-banner-add" class="btn btn-primary text-capitalize text-nowrap">
            ...
            <div class="table-responsive">
              <table id="columnSearchDatatable"
                     class="table-hover table-borderless table-thead-bordered table align-middle">
                    ...
                    <tr id="data-{{ $banner->id }}">
                        ...
                        <form action="{{ route('admin.banner.status') }}" method="post"
                          ...
                          <label class="switcher" for="banner-status{{ $banner['id'] }}">
                            <input class="switcher_input custom-modal-plugin" type="checkbox" value="1"
                                   name="status" id="banner-status{{ $banner['id'] }}"
                                   {{ $banner['published'] == 1 ? 'checked' : '' }} data-modal-type="input-change-form"
                      ...
                      <td>
                        <div class="d-flex justify-content-center gap-10">
                          <a class="btn btn-outline-primary icon-btn edit" title="{{ translate('edit') }}"
            ...
            <div class="table-responsive">
              <div class="d-flex justify-content-lg-end px-4">
                {{ $banners->links() }}
              </div>
            </div>
