...
@section('content')
  <div class="content container-fluid">
    ...
    <div class="card">
      <div class="px-3 py-4">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-10">
          <div class="">
          ...
          <div class="d-flex justify-content-end gap-3">
            <a type="button" class="btn btn-outline-primary text-nowrap"
              ...
              <img width="14" src="{{ dynamicAsset(path: 'public/assets/back-end/img/excel.png') }}" class="excel"
                   alt="">
        ...
        <div class="table-responsive">
          <table
                 class="table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100 table">
            ...
            <tbody>
              @foreach ($vendors as $key => $seller)
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center w-max-content gap-10">
                  ...
                  <td>
                    <a title="{{ translate('view') }}" class="text-dark text-hover-primary"
                  ...
                  <td>
                    {!! $seller->status == 'approved'
                        ? '<label class="badge badge-success text-bg-success">' . translate('active') . '</label>'
                        : '<label class="badge badge-danger text-bg-danger">' . translate('inactive') . '</label>' !!}
                  </td>
                  ...
                  <td>
                    <div class="d-flex justify-content-center gap-2">
                      <a title="{{ translate('view') }}" class="btn btn-outline-info icon-btn"
                         href="{{ route('admin.report.vendor-report-view', $seller->id) }}">
