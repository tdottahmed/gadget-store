...
<aside class="js-aside aside d-none d-lg-block">
  <div class="aside-header d-flex align-items-center justify-content-between gap-2">
  ...
  <div class="aside-body search-aside-attribute-container py-4 pt-0">
    <div class="aside-search-form pt-lg-3 pb-3">
      <div class="input-group flex-nowrap">
        <input type="text" class="form-control search-aside-attribute" placeholder="{{ translate('search_menu') }}">
    ...
    <ul class="aside-nav navbar-nav gap-2">
      <li>
        <a class="nav-link {{ Request::is('admin/dashboard') ? 'active' : '' }}" title="{{ translate('dashboard') }}"
      ...
      @if (Helpers::module_permission_check('order_management'))
        ...
        <li class="{{ Request::is('admin/orders*') ? 'sub-menu-opened' : '' }}">
          ...
          <ul class="aside-submenu navbar-nav">
            <li class="nav-item fw-semibold text-dark bg-section2 aside-mini-show-element px-3 py-2">
              {{ translate('orders') }}</li>
            <li class="nav-item">
      ...
      @if (Helpers::module_permission_check('product_management'))
        ...
        <li class="{{ Request::is('admin/brand*') ? 'sub-menu-opened' : '' }}">
          <a class="nav-link nav-link-toggle {{ Request::is('admin/brand*') ? 'active' : '' }}" href="javascript:"
      ...
      @if (Helpers::module_permission_check('support_section'))
        ...
        <li>
          <a class="nav-link {{ Request::is('admin/messages*') ? 'active' : '' }}"
             title="{{ translate('inbox') }}" href="{{ route('admin.messages.index', ['type' => 'customer']) }}">
          ...
          <a class="nav-link {{ Request::is('admin/contact*') ? 'active' : '' }}"
            ...
            <span class="aside-mini-hidden-element text-truncate">
              <span class="position-relative">
                ...
                @if ($message != 0)
                  <span class="btn-status btn-xs-status btn-status-danger position-absolute menu-status top-0"></span>
                @endif
              </span>
            </span>
          </a>
      ...
      @if (Helpers::module_permission_check('blog_management'))
        @if (Route::has('admin.blog.view'))
          ...
          <li class="{{ Request::is('admin/blog/*') ? 'sub-menu-opened' : '' }}">
            <a class="nav-link nav-link-toggle {{ Request::is('admin/blog*') ? 'active' : '' }}" href="javascript:"
          ...
          <ul class="aside-submenu navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{ Request::is('admin/customer/loyalty/report') ? 'active' : '' }}"
                 title="{{ translate('loyalty_Points') }}" href="{{ route('admin.customer.loyalty.report') }}">
                <span class="text-truncate">
          ...
          <ul class="aside-submenu navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{ Request::is('admin/delivery-man/withdraw-list') || Request::is('admin/delivery-man/withdraw-view*') ? 'active' : '' }}"
                 href="{{ route('admin.delivery-man.withdraw-list') }}" title="{{ translate('withdraws') }}">
                <span class="text-truncate">{{ translate('withdraws') }}</span>
              </a>
            </li>
            <li class="nav-item">
      ...
      @if (Helpers::module_permission_check('system_settings'))
        ...
        <li>
          <a class="nav-link {{ Request::is('admin/system-setup/environment-setup') ||
        ...
        <li>
          <a class="nav-link {{ Request::is('admin/system-setup/login-settings/login-url-setup') ||
      ...
      @if (Helpers::module_permission_check('3rd_party_setup'))
        ...
        <li>
          <a class="nav-link {{ Request::is('admin/third-party/payment-method') ||
        ...
        {{-- <li>
          <a class="nav-link {{ Request::is('admin/third-party/firebase-configuration/setup') ||
...
<div class="offcanvas offcanvas-start bg-panel d-lg-none w-280" tabindex="-1" id="offcanvasAside"
  ...
  <div class="offcanvas-header d-flex align-items-center justify-content-between gap-2">
    <a class="navbar-logo" href="{{ route('admin.dashboard.index') }}">
      <img height="24" src="{{ getStorageImages(path: $eCommerceLogo, type: 'backend-logo') }}"
           alt="{{ translate('logo') }}">
    </a>

    <button type="button" class="border-0 bg-transparent p-0 text-white" data-bs-dismiss="offcanvas"
            aria-label="Close">
